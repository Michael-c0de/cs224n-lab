...
# from sanity_check import BATCH_SIZE, HIDDEN_SIZE
...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        PackedSequence=pack_padded_sequence(input=X,lengths=source_lengths,enforce_sorted=False)
        enc_hiddens,(last_hidden,last_cell)=self.encoder(PackedSequence)
